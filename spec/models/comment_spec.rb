...
describe Comment do
  before(:each) do
    ...
    @product = Product.new :name => "my product", :url => "http://foo.bar", :description => "the description has to be pretty long", :platforms => [@platform], :category => @category, :publisher => @publisher_and_commenter
